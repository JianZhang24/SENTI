...
def add_config(parser):
    ...
    group.add_argument("-no_mse", action="store_true")
    group.add_argument("-no_drp", action="store_true")
    group.add_argument("-mse_weight", type=float, default=0.001)
    group.add_argument("-drp_weight", type=float, default=0.001)
    group.add_argument("-swd_proj_k", type=int, default=4)
    group.add_argument("-primary_modality", type=str, default="auto",
                       choices=["auto", "text", "audio", "video"])
    ...
    group.add_argument("-text_as_anchor", action="store_true")
    group.add_argument("-anchor_graph_fusion", action="store_true")
    group.add_argument("-anchor_contrast_temp", type=float, default=0.07)
